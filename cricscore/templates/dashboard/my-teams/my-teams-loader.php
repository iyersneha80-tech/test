...
$assets_dir_url = CRICSCORE_URL . 'templates/dashboard/my-teams/assets/';

// 2. Enqueue the stylesheet with cache busting.
$css_file_path = $assets_dir_path . 'css/my-teams-style.css';
if ( file_exists( $css_file_path ) ) {
    wp_enqueue_style(
        'cricscore-my-teams-style',
        $assets_dir_url . 'css/my-teams-style.css',
...
$js_file_path = $assets_dir_path . 'my-teams-script.js';
if ( file_exists( $js_file_path ) ) {
    $handle = 'cricscore-my-teams-script';
    wp_enqueue_script(
        $handle,
        $assets_dir_url . 'my-teams-script.js',
...
include_once __DIR__ . '/my-teams-view.php';