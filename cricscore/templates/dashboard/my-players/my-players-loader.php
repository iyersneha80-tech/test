<?php
/**
 * Loader for the "My Players" view.
...
$assets_dir_url = CRICSCORE_URL . 'templates/dashboard/my-players/assets/';

// 2. Enqueue the stylesheet with cache busting.
$css_file_path = $assets_dir_path . 'css/my-players-style.css';
if ( file_exists( $css_file_path ) ) {
    wp_enqueue_style(
        'cricscore-my-players-style',
        $assets_dir_url . 'css/my-players-style.css',
...
$js_file_path = $assets_dir_path . 'my-players-script.js';
if ( file_exists( $js_file_path ) ) {
    $handle = 'cricscore-my-players-script';
    wp_enqueue_script(
        $handle,
        $assets_dir_url . 'my-players-script.js',
...
include_once __DIR__ . '/my-players-view.php';