<?php
/**
 * Loader for the "My Tournaments" view.
...
$assets_dir_url = CRICSCORE_URL . 'templates/dashboard/my-tournaments/assets/';

// 2. Enqueue the stylesheet with cache busting.
$css_file_path = $assets_dir_path . 'css/style.css';
if ( file_exists( $css_file_path ) ) {
    wp_enqueue_style(
        'cricscore-my-tournaments-style',
...
$js_file_path = $assets_dir_path . 'my-tournaments-script.js';
if ( file_exists( $js_file_path ) ) {
    $handle = 'cricscore-my-tournaments-script';
    wp_enqueue_script(
        $handle,
        $assets_dir_url . 'my-tournaments-script.js',
...
include_once __DIR__ . '/my-tournaments-view.php';